...
const translations = {
  fr: {
    ...
    // CTA haut
    cta_hero_btn:
      "Prêt à concrétiser votre projet immobilier ? Contactez-moi maintenant",
    cta_hero_whats: "Discutons sur WhatsApp",

    // POUR QUI
    who_title: "Ce service est fait pour vous si…",
    who_retirees_title: "Retraités",
    who_retirees_text:
      "Profitez de votre retraite sans vous ruiner : villa avec piscine au prix d’un studio en banlieue… et il reste du budget.",
    who_remote_title: "Télétravailleurs",
    who_remote_text:
    ...
    why_es_title: "🇪🇸 Espagne",
    why_es_li1: "Fiscalité attractive (loi Beckham pour certains profils)",
    why_es_li2: "Prix ~ −40% vs. côte française",
    why_es_li3: "2h d’avion de Paris",
    why_es_li4: "Communauté francophone bien établie",
    why_es_li5: "Qualité de vie exceptionnelle",
    why_ma_title: "🇲🇦 Maroc",
    why_ma_li1: "Coût de la vie ~ −50% vs. France",
    why_ma_li2: "320 jours de soleil/an",
    why_ma_li3: "Coupe du Monde 2030 → valorisation attendue",
    why_ma_li4: "Proximité culturelle & géographique",
    why_ma_li5: "Immobilier très accessible",
    why_guide_btn: "Télécharger le guide complet",

    // COMPARATIF
    comparatif_title: "Concrètement, combien ça change ?",

    // GUIDES
    guides_title: "Guides gratuits pour bien démarrer",
    guide1_title: "5 erreurs fatales avant d’acheter au Maroc",
    guide1_text:
      "Évitez les pièges courants : cadastre, avocat, clauses, délais, acompte…",
    guide2_title: "Checklist : Acheter en Espagne en 2025",
    guide2_text:
      "Check-list claire : budget, NIE, notaire, fiscalité, banques, étapes clés…",
    guide3_title: "Fiscalité expatriés : l’essentiel",
    guide3_text:
      "Ce qu’il faut savoir avant de partir : résidence fiscale, conventions, impôts.",
    guide_btn: "Télécharger gratuitement",

    // TÉMOIGNAGES
    temoignages_title: "Ils ont franchi le pas",
    temoignages_note:
      "Premiers clients actuellement accompagnés. Témoignages et retours d’expérience arrivent très bientôt.",
    temoignages_intro:
      "Vous avez acheté à l’étranger ? Partagez votre expérience :",
    temoignages_link: "envoyer un témoignage",
    ...
    faq_q4: "Puis-je obtenir un crédit en tant qu’étranger ?",
    faq_a4:
      "Oui. Je vous mets en relation avec des banques partenaires en fonction de votre profil.",

    // CTA bas
    contact_whats_btn:
      "Des questions ? Je réponds sous 24h – Discutons sur WhatsApp",
  ...
  en: {
    ...
    guide1_text:
      "Avoid common traps: land registry, lawyer, clauses, timing, deposit…",
    guide2_title: "Checklist: Buying in Spain in 2025",
    guide2_text:
      "Clear checklist: budget, NIE, notary, tax, banks, key steps…",
    ...
    contact_whats_btn:
      "Questions? I reply within 24h – Let’s talk on WhatsApp",
  ...
  it: {
    ...
    contact_whats_btn:
      "Domande? Ti rispondo entro 24h – Parliamone su WhatsApp",
...
const countryLinks = {
  ma: { // Maroc
    fr: "https://sites.google.com/view/mediterranea-property-cons-mfr?usp=sharing",
    en: "https://sites.google.com/view/mediterraneapropertycons-men?usp=sharing",
    it: "https://sites.google.com/view/mediterranea-property-cons-mit?usp=sharing"
  },
  es: { // Espagne
    fr: "https://sites.google.com/view/mediterranea-property-cons-efr?usp=sharing",
    en: "https://sites.google.com/view/mediterraneapropertycons-een?usp=sharing",
    it: "https://sites.google.com/view/mediterraneapropertycons-eit?usp=sharing"
  },
  it: { // Italie
    fr: "https://sites.google.com/view/mediterranea-property-cons-ifr/propri%C3%A9t%C3%A9s-en-vente-%C3%A0-la-une?authuser=1",
    en: "https://sites.google.com/view/mediterranea-property-cons-ien?usp=sharing"
